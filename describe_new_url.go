...
// DescribeNewURL
func (m *MediaAssetClient) DescribeNewURL(req *request.DescribeNewURLRequest) (
	rsp *response.DescribeNewURLResponse, err error) {
	rsp = &response.DescribeNewURLResponse{}
	if m.Port == 0 {
		m.Port = 80
	}
